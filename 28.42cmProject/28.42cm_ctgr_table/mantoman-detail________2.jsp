...
<script type="text/javascript">
	function handleRadioClick(value) {
		...
		// 라디오 선택시 나타나는 div 숨김
		check01.classList.add('hidden');
		check02.classList.add('hidden');
		
		// 선택된 라디오 버튼에 따라 특정 div 표시
		if (value === '1') {
						...
						<ul class="tb_lst">
							<li>
								...
								<div class="in_td">
									...
									<span> 
									<input type="radio" id="chk1" value="1" name="product" > 
										<label title="배송문의" style="padding-left: 25px;">배송문의</label>
									</span> 
									</uio-radio>
									<uio-radio class="ng-star-inserted" id="order_radio"> 
									<span> 
									<input
										type="radio" id="chk2" value="1" name="product"> 
										<label title="주문문의" style="padding-left: 25px;">주문문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted" id="order_radio">
									<span> 
									<input type="radio" id="chk3" value="1" name="product"> 
									<label title="취소문의" style="padding-left: 25px;">취소문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted"
										id="order_radio"> <span> <input
										type="radio" id="chk4" value="1" name="product"> <label title="반품문의"
										style="padding-left: 25px;">반품문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted" id="order_radio">
									<span> <input type="radio" id="chk5" value="1" name="product"> <label
										title="교환문의" style="padding-left: 25px;">교환문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted" id="order_radio">
									<span> <input type="radio" id="chk6" value="1" name="product"> <label
										title="환불문의" style="padding-left: 25px;">환불문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted" id="order_radio">
									<span> <input type="radio" id="chk7" value="1" name="product"> <label
										title="사은품문의" style="padding-left: 25px;">사은품문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted" id="order_radio">
									<span> <input type="radio" id="chk8" value="1" name="product"> <label
										title="입금문의" style="padding-left: 25px;">입금문의</label>
									</span> </uio-radio>
									<!---->
								</div>
							...
							<li>
							 <!--라디오 선택시 나타나는 새로운 창-->
								<div class="check01">
									<ul class="clear">
										<li class="order_no ng-star-inserted" id="order">
								<div class="in_td">
									<strong class="type">주문번호</strong>
								</div>
								<div class="in_td orderno_td">
									<input type="text" id="orderNo" formcontrolname="order_serial"
										placeholder=" " class="ng-untouched ng-pristine"
									...
									<button type="button" class="btn btn_bor">번호 조회</button>
										...
										<li class="order_no order_bx ng-star-inserted" id="order">
											<div class="in_td">
							...
							<li>
								...
								<div class="in_td">
									<uio-radio class="ng-star-inserted"> <span>
										<input type="radio" name="person"> <label
										title="회원정보문의" style="padding-left: 25px;">회원정보문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted"> <span>
										<input type="radio" name="person"> <label
										title="회원제도문의" style="padding-left: 25px;">회원제도문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted"> <span>
										<input type="radio" name="person"> <label
										title="결제방법문의" style="padding-left: 25px;">결제방법문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted"> <span>
										<input type="radio" id="chk9" value="2" name="inquiry" > <label
										title="상품문의" style="padding-left: 25px;">상품문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted"> <span>
										<input type="radio" name="person"> <label title="당첨문의"
										style="padding-left: 25px;">당첨문의</label>
									</span> </uio-radio>
									<uio-radio class="ng-star-inserted"> <span>
										<input type="radio" name="person"> <label
										title="쿠폰/마일리지문의" style="padding-left: 25px;">쿠폰/마일리지문의</label>
									</span> </uio-radio>
									<!---->
								</div>
							</li>
							<li>
							  <div class="check02">
									<ul class="clear">
										<li class="item ng-star-inserted" id="item">
											<div class="in_td">
										...
										<li class="item_info ng-star-inserted" id="item">
											<div class="in_td">
												<strong class="type">상품명</strong>
											</div>
