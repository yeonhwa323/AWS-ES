					...
					<div  class="my_inquire_info">
						...
						<div class="m_view">
							<div class="write_btnbx">
								<a class="btn_bor"
									href="/jspPro/sentiBoard/list/qna-mantoman/mantoman-detail.jsp">1:1 문의
									내역 보기 - 관리자전용</a> <a href="tel:1644-0560"
					...
					<div class="my_tbl_lst my_tbl_inquire">
						<div class="my_tbl my_tbl_tit">
							<div class="my_tbl_info">
								<p class="type" align="left" width="50">글번호</p>
								<p class="tit" align="center">상담제목</p>
								<p class="tit" align="center">사진파일</p>
								<p class="date" align="right" width="50">작성일</p>
								<p class="state" align="right" width="20">답변유무</p>
								<p class="tblbtn">
